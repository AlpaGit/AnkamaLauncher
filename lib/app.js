...
exports.setup = function () {
  ...
  const shouldExit = this.makeSingleInstance(() => {
    // If main is not in windows, the app is starting
    // Main window should be open soon
    if ('main' in this.windows) {
      this.openWindow('main')
    }
  })

  if (shouldExit) {
    logger.warn('Another copy of zaap is running, exiting', {
